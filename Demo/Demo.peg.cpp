...
QtnPropertySetSubPropertySetType &QtnPropertySetSubPropertySetType::operator=(
	const QtnPropertySetSubPropertySetType &other)
{
	Q_UNUSED(other);
...
QtnPropertySet *QtnPropertySetSubPropertySetType::createNewImpl(
	QObject *parentForNew) const
{
	return new QtnPropertySetSubPropertySetType(parentForNew);
}

QtnPropertySet *QtnPropertySetSubPropertySetType::createCopyImpl(
	QObject *parentForCopy) const
{
	QtnPropertySetSubPropertySetType *p =
		new QtnPropertySetSubPropertySetType(parentForCopy);
	*p = *this;
	return p;
}

bool QtnPropertySetSubPropertySetType::copyValuesImpl(
	QtnPropertySet *propertySetCopyFrom, QtnPropertyState ignoreMask)
{
	Q_UNUSED(ignoreMask);

	auto theCopyFrom =
		qobject_cast<QtnPropertySetSubPropertySetType *>(propertySetCopyFrom);
	if (!theCopyFrom)
		return false;
...
void QtnPropertySetSubPropertySetType::init()
{
	...
	static QString description =
		"This property set is part of the root property set.";
	...
	static QString SwitchProperty_description =
		"Boolean property with customized True/False values.";
	...
	static QString ReadOnlyString_description =
		"This property is callback and read-only.";
	...
	static QString FileNameProperty_description =
		"QString property tuned to handle file names.";
	FileNameProperty.setDescription(FileNameProperty_description);
	FileNameProperty.setValue("~/test_file.txt");
	static QString FolderNameProperty_name =
		QStringLiteral("FolderNameProperty");
	FolderNameProperty.setName(FolderNameProperty_name);
	static QString FolderNameProperty_description =
		"QString property tuned to handle folder names.";
	...
	static QString StringFromList_description =
		"QString property with list of acepted values (one, two, three, four).";
	...
	static QString CircleShapeColor_description =
		"QColor property with delegate tuned to draw circle";
...
void QtnPropertySetSubPropertySetType::connectDelegates()
{
	...
	FileNameProperty.setDelegateInfoCallback([]() -> QtnPropertyDelegateInfo {
		...
		info.attributes["nameFilters"] = QStringList()
	...
	StringFromList.setDelegateInfoCallback([]() -> QtnPropertyDelegateInfo {
		QtnPropertyDelegateInfo info;
		info.name = "ComboBox";
		info.attributes["items"] = QStringList()
			<< "one" << "two" << "three" << "four";
		return info;
	});
...
QtnPropertySetSamplePS::QtnPropertySetSamplePS(QObject *parent)
	...
	, SubPropertySet2(
		  *qtnCreateProperty<QtnPropertySetSubPropertySetType>(this))
{
	init();
	connectSlots();
	connectDelegates();
...
QtnPropertySetSamplePS &QtnPropertySetSamplePS::operator=(
	const QtnPropertySetSamplePS &other)
{
	Q_UNUSED(other);
...
QtnPropertySet *QtnPropertySetSamplePS::createNewImpl(
	QObject *parentForNew) const
{
	return new QtnPropertySetSamplePS(parentForNew);
}

QtnPropertySet *QtnPropertySetSamplePS::createCopyImpl(
	QObject *parentForCopy) const
{
...
bool QtnPropertySetSamplePS::copyValuesImpl(
	QtnPropertySet *propertySetCopyFrom, QtnPropertyState ignoreMask)
{
	Q_UNUSED(ignoreMask);

	auto theCopyFrom =
		qobject_cast<QtnPropertySetSamplePS *>(propertySetCopyFrom);
	if (!theCopyFrom)
		return false;
...
void QtnPropertySetSamplePS::init()
{
	...
	static QString BoolProperty_description =
		"Property to hold boolean values.";
	...
	static QString ButtonProperty_description =
		"Start calculate a long operation.";
	ButtonProperty.setDescription(ButtonProperty_description);
	static QString ButtonLinkProperty_name =
		QStringLiteral("ButtonLinkProperty");
	...
	RGBColor.setClickHandler([this](const QtnPropertyABColor *color) {
		...
		RGBColor = QColor::fromRgb(QRandomGenerator::global()->bounded(256),
			QRandomGenerator::global()->bounded(256),
			QRandomGenerator::global()->bounded(256));
	});
	static QString RGBColor_description =
		"ABColor property with RGB components";
	RGBColor.setDescription(RGBColor_description);
	RGBColor.setValue(QColor(123, 150, 10));
	static QString ColorSolidDelegate_name =
		QStringLiteral("ColorSolidDelegate");
	ColorSolidDelegate.setName(ColorSolidDelegate_name);
	static QString ColorSolidDelegate_description =
		"QColor property with Solid delegate";
	ColorSolidDelegate.setDescription(ColorSolidDelegate_description);
	ColorSolidDelegate.setValue(QColor(13, 150, 10));
	static QString FloatPropertySliderBox_name =
		QStringLiteral("FloatPropertySliderBox");
	FloatPropertySliderBox.setName(FloatPropertySliderBox_name);
	static QString FloatPropertySliderBox_description =
		"Property to hold float values in range [0, 10].";
	...
	static QString FloatPercent_description =
		"Property to hold float values in range [0-1] visible as [0%-100%].";
	...
	static QString DoublePercent_description =
		"Property to hold double values in range [0-1] visible as [0%-100%].";
	...
	static QString FloatIntRangeSliderBox_name =
		QStringLiteral("FloatIntRangeSliderBox");
	FloatIntRangeSliderBox.setName(FloatIntRangeSliderBox_name);
	static QString FloatIntRangeSliderBox_description =
		"Property to hold float values in full range.";
	FloatIntRangeSliderBox.setDescription(FloatIntRangeSliderBox_description);
	FloatIntRangeSliderBox.setMaxValue(
		float(1 << std::numeric_limits<float>::digits));
	FloatIntRangeSliderBox.setMinValue(
		-float(1 << std::numeric_limits<float>::digits));
	FloatIntRangeSliderBox.setValue(111.f);
	static QString DoubleFullRangeSliderBox_name =
	...
	static QString DoubleFullRangeSliderBox_description =
		"Property to hold double values in full range.";
	DoubleFullRangeSliderBox.setDescription(
		DoubleFullRangeSliderBox_description);
	DoubleFullRangeSliderBox.setMaxValue(
		double(1LL << std::numeric_limits<double>::digits));
	DoubleFullRangeSliderBox.setMinValue(
		-double(1LL << std::numeric_limits<double>::digits));
	...
	static QString DoubleProperty_description =
		"Property to hold double values in range [10, 20].";
	...
	static QString FloatProperty_description =
		"Property to hold float values in range [-10, 0].";
	...
	static QString IntProperty_description =
		"Property to hold integer values with changing step 15.";
	IntProperty.setDescription(IntProperty_description);
	IntProperty.setStepValue(15);
	IntProperty.setValue(10);
	static QString IntPropertyComboBox_name =
		QStringLiteral("IntPropertyComboBox");
	IntPropertyComboBox.setName(IntPropertyComboBox_name);
	static QString IntPropertyComboBox_description =
		"Property to hold integer values with changing step 15.";
	...
	static QString UIntProperty_description =
		"Property to hold unsigned integer values in range [100, 200].";
	...
	static QString Int64Property_description =
		"Property to hold signed integer 64-bit value";
	...
	static QString UInt64Property_description =
		"Property to hold signed integer 64-bit value";
	...
	static QString Int64SliderBox_description =
		"Property to hold signed integer 64-bit value with slider box";
	...
	static QString UInt64SliderBox_description =
		"Property to hold unsigned integer 64-bit value with slider box";
	...
	static QString EnumProperty_description =
		"Property to hold enum value (color).";
	...
	static QString EnumFlagsProperty_description =
		"Property to hold combination of enum values (options).";
	...
	static QString EnableSubPropertySet_name =
		QStringLiteral("EnableSubPropertySet");
	EnableSubPropertySet.setName(EnableSubPropertySet_name);
	static QString EnableSubPropertySet_description =
		"Enable/Disable Sub-PropertySet.";
	...
	static QString SubPropertySet_description =
		"This property set is part of the root property set.";
	...
	static QString QPointProperty_description =
		"Property to hold QPoint value.";
	...
	static QString QPointFProperty_description =
		"Property to hold QPointF value.";
	...
	static QString QSizeFProperty_description =
		"Property to hold QSizeF value.";
	...
	static QString QRectFProperty_description =
		"Property to hold QRectF value.";
	...
	static QString QVector3DProperty_description =
		"Property to hold QVector3D value.";
	...
	static QString QColorProperty_description =
		"Property to hold QColor value.";
	...
	static QString FreqProperty_description =
		"Property to hold frequency values.";
	...
	static QString BrushStyleProperty_name =
		QStringLiteral("BrushStyleProperty");
	BrushStyleProperty.setName(BrushStyleProperty_name);
	static QString BrushStyleProperty_description =
		"Property to hold QBrushStyle enum.";
	...
	static QString PenWidthProperty_description =
		"Property to hold PenWidth enum.";
	...
	static QString PenStyleProperty_description =
		"Property to hold pen style values.";
	...
	static QString QStringCallbackProperty_name =
		QStringLiteral("QStringCallbackProperty");
	QStringCallbackProperty.setName(QStringCallbackProperty_name);
	static QString QStringCallbackProperty_description =
		"Property to hold QString values with candidates.";
...
{
	QObject::connect(&EnableSubPropertySet, &QtnProperty::propertyDidChange,
		this,
		&QtnPropertySetSamplePS::on_EnableSubPropertySet_propertyDidChange);
	QObject::connect(&QColorProperty, &QtnProperty::propertyDidChange, this,
		&QtnPropertySetSamplePS::on_QColorProperty_propertyDidChange);
}

void QtnPropertySetSamplePS::disconnectSlots()
{
	QObject::disconnect(&EnableSubPropertySet, &QtnProperty::propertyDidChange,
		this,
		&QtnPropertySetSamplePS::on_EnableSubPropertySet_propertyDidChange);
	QObject::disconnect(&QColorProperty, &QtnProperty::propertyDidChange, this,
		&QtnPropertySetSamplePS::on_QColorProperty_propertyDidChange);
}
	...
	QtnPropertyChangeReason reason)
{
	...
	SubPropertySet.switchState(
		QtnPropertyStateImmutable, !EnableSubPropertySet);
}

void QtnPropertySetSamplePS::on_QColorProperty_propertyDidChange(
	QtnPropertyChangeReason reason)
{
	Q_UNUSED(reason);
...
void QtnPropertySetSamplePS::connectDelegates()
{
	...
	FloatPropertySliderBox.setDelegateInfoCallback(
	...
	FloatIntRangeSliderBox.setDelegateInfoCallback(
		[]() -> QtnPropertyDelegateInfo {
			QtnPropertyDelegateInfo info;
			info.name = "SliderBox";
			info.attributes["drawBorder"] = false;
	...
	DoubleFullRangeSliderBox.setDelegateInfoCallback(
		[]() -> QtnPropertyDelegateInfo {
			QtnPropertyDelegateInfo info;
			info.name = "SliderBox";
			info.attributes["drawBorder"] = false;
	...
	IntPropertyComboBox.setDelegateInfoCallback(
		[]() -> QtnPropertyDelegateInfo {
			QtnPropertyDelegateInfo info;
			info.name = "IntList";
			info.attributes["values"] =
				QVariant::fromValue(QList<int>() << 10 << 12 << 15);
			return info;
		});
