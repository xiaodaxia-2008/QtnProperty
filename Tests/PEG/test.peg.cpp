...
QtnPropertySetTest1 &QtnPropertySetTest1::operator=(
	const QtnPropertySetTest1 &other)
{
	Q_UNUSED(other);
...
QtnPropertySet *QtnPropertySetTest1::createCopyImpl(
...
bool QtnPropertySetTest1::copyValuesImpl(
...
void QtnPropertySetTest1::init()
{
	...
	static QString text_description = "defrf\"sde\""
									  "deerf3rf"
									  "derf r g\r\nreg r{}"
									  "dfrgerg"
									  "fwrewre";
...
QtnPropertySetTest2 &QtnPropertySetTest2::operator=(
	const QtnPropertySetTest2 &other)
{
	Q_UNUSED(other);
...
QtnPropertySet *QtnPropertySetTest2::createCopyImpl(
	QObject *parentForCopy) const
{
...
bool QtnPropertySetTest2::copyValuesImpl(
	QtnPropertySet *propertySetCopyFrom, QtnPropertyState ignoreMask)
{
	Q_UNUSED(ignoreMask);
...
bool QtnPropertySetYY::copyValuesImpl(
	QtnPropertySet *propertySetCopyFrom, QtnPropertyState ignoreMask)
{
	Q_UNUSED(ignoreMask);
...
bool QtnPropertySetAA::copyValuesImpl(
	QtnPropertySet *propertySetCopyFrom, QtnPropertyState ignoreMask)
{
	Q_UNUSED(ignoreMask);
...
bool QtnPropertySetSS::copyValuesImpl(
	QtnPropertySet *propertySetCopyFrom, QtnPropertyState ignoreMask)
{
	Q_UNUSED(ignoreMask);
...
QtnPropertySetTest3 &QtnPropertySetTest3::operator=(
	const QtnPropertySetTest3 &other)
{
	Q_UNUSED(other);
...
QtnPropertySet *QtnPropertySetTest3::createCopyImpl(
	QObject *parentForCopy) const
{
...
bool QtnPropertySetTest3::copyValuesImpl(
	QtnPropertySet *propertySetCopyFrom, QtnPropertyState ignoreMask)
{
	Q_UNUSED(ignoreMask);
...
void QtnPropertySetTest3::init()
{
	...
	bc.setCallbackValueGet([this]() -> bool { return ww; });
	bc.setCallbackValueSet(
		[this](
			bool value, QtnPropertyChangeReason /*reason*/) { m_s = value; });
	bc.setId(12);
	// end children initialization
}
...
{
	QObject::connect(this, &QtnProperty::propertyDidChange, this,
		&QtnPropertySetTest3::on_propertyDidChange);
	QObject::connect(&u, &QtnProperty::propertyWillChange, this,
		&QtnPropertySetTest3::on_u_propertyWillChange);
	QObject::connect(&u, &QtnProperty::propertyDidChange, this,
		&QtnPropertySetTest3::on_u_propertyDidChange);
	QObject::connect(&s.a, &QtnProperty::propertyValueAccept, this,
		&QtnPropertySetTest3::on_s_a_propertyValueAccept);
	QObject::connect(&s.a, &QtnProperty::propertyWillChange, this,
		&QtnPropertySetTest3::on_s_a_propertyWillChange);
}

void QtnPropertySetTest3::disconnectSlots()
{
	QObject::disconnect(this, &QtnProperty::propertyDidChange, this,
		&QtnPropertySetTest3::on_propertyDidChange);
	QObject::disconnect(&u, &QtnProperty::propertyWillChange, this,
		&QtnPropertySetTest3::on_u_propertyWillChange);
	QObject::disconnect(&u, &QtnProperty::propertyDidChange, this,
		&QtnPropertySetTest3::on_u_propertyDidChange);
	QObject::disconnect(&s.a, &QtnProperty::propertyValueAccept, this,
		&QtnPropertySetTest3::on_s_a_propertyValueAccept);
	QObject::disconnect(&s.a, &QtnProperty::propertyWillChange, this,
		&QtnPropertySetTest3::on_s_a_propertyWillChange);
}
...
void QtnPropertySetTest3::on_u_propertyWillChange(
...
void QtnPropertySetTest3::on_s_a_propertyValueAccept(
...
void QtnPropertySetTest3::on_s_a_propertyWillChange(
	QtnPropertyChangeReason reason, QtnPropertyValuePtr newValue, int typeId)
{
	Q_UNUSED(reason);
	Q_UNUSED(newValue);
...
static QtnEnumInfo &create_COLOR_info()
{
	...
	staticValues.append(QtnEnumValueInfo(COLOR::BLUE, "BLUE", "Blue",
		QtnEnumValueStateHidden | QtnEnumValueStateObsolete));
...
QtnPropertySetAllPropertyTypes &QtnPropertySetAllPropertyTypes::operator=(
	const QtnPropertySetAllPropertyTypes &other)
{
	Q_UNUSED(other);
...
QtnPropertySet *QtnPropertySetAllPropertyTypes::createNewImpl(
	QObject *parentForNew) const
{
	return new QtnPropertySetAllPropertyTypes(parentForNew);
}

QtnPropertySet *QtnPropertySetAllPropertyTypes::createCopyImpl(
	QObject *parentForCopy) const
{
	QtnPropertySetAllPropertyTypes *p =
		new QtnPropertySetAllPropertyTypes(parentForCopy);
	*p = *this;
	return p;
}

bool QtnPropertySetAllPropertyTypes::copyValuesImpl(
	QtnPropertySet *propertySetCopyFrom, QtnPropertyState ignoreMask)
{
	Q_UNUSED(ignoreMask);

	auto theCopyFrom =
		qobject_cast<QtnPropertySetAllPropertyTypes *>(propertySetCopyFrom);
	if (!theCopyFrom)
		return false;
...
void QtnPropertySetAllPropertyTypes::init()
{
	...
	bpc.setCallbackValueSet(
		[this](bool v, QtnPropertyChangeReason /*reason*/) { _b = v; });
	bpc.setId(15);
	...
	ipc.setCallbackValueSet(
		[this](qint32 v, QtnPropertyChangeReason /*reason*/) { _i = v; });
	ipc.setId(17);
	...
	upc.setCallbackValueSet(
		[this](quint32 v, QtnPropertyChangeReason /*reason*/) { _ui = v; });
	upc.setId(19);
	...
	fpc.setCallbackValueSet(
		[this](float v, QtnPropertyChangeReason /*reason*/) { _f = v; });
	fpc.setId(21);
	...
	dpc.setCallbackValueSet(
		[this](double v, QtnPropertyChangeReason /*reason*/) { _d = v; });
	dpc.setId(23);
	...
	spc.setCallbackValueSet(
		[this](QString v, QtnPropertyChangeReason /*reason*/) { _s = v; });
	spc.setId(25);
	...
	rpc.setCallbackValueSet(
		[this](QRect v, QtnPropertyChangeReason /*reason*/) { _r = v; });
	rpc.setId(27);
	...
	ppc.setCallbackValueSet(
		[this](QPoint v, QtnPropertyChangeReason /*reason*/) { _p = v; });
	ppc.setId(29);
	...
	szpc.setCallbackValueSet(
		[this](QSize v, QtnPropertyChangeReason /*reason*/) { _sz = v; });
	szpc.setId(31);
	...
	epc.setCallbackValueSet(
		[this](QtnEnumValueType v, QtnPropertyChangeReason /*reason*/) {
			_e = v;
		});
	...
	efpc.setCallbackValueSet(
		[this](QtnEnumFlagsValueType v, QtnPropertyChangeReason /*reason*/) {
			_ef = v;
		});
	...
	cpc.setCallbackValueSet(
		[this](QColor v, QtnPropertyChangeReason /*reason*/) { _cl = v; });
	cpc.setId(37);
	...
	fnpc.setCallbackValueSet(
		[this](QFont v, QtnPropertyChangeReason /*reason*/) { _fn = v; });
	fnpc.setId(39);
	...
	ppfc.setCallbackValueSet(
		[this](QPointF v, QtnPropertyChangeReason /*reason*/) { _pf = v; });
	ppfc.setId(42);
	...
	rpfc.setCallbackValueSet(
		[this](QRectF v, QtnPropertyChangeReason /*reason*/) { _rf = v; });
	rpfc.setId(44);
	...
	szpfc.setCallbackValueSet(
		[this](QSizeF v, QtnPropertyChangeReason /*reason*/) { _szf = v; });
	szpfc.setId(46);
	// end children initialization
}
...
static QtnEnumInfo &create_MY_TYPE_info()
{
	QVector<QtnEnumValueInfo> staticValues;
	staticValues.append(
		QtnEnumValueInfo(MY_TYPE::MY_TYPE1, "MY_TYPE1", "My type 1"));
	staticValues.append(
		QtnEnumValueInfo(MY_TYPE::MY_TYPE2, "MY_TYPE2", "My type 2"));
...
QtnPropertySetTest12 &QtnPropertySetTest12::operator=(
	const QtnPropertySetTest12 &other)
{
	Q_UNUSED(other);
...
QtnPropertySet *QtnPropertySetTest12::createCopyImpl(
	QObject *parentForCopy) const
{
...
bool QtnPropertySetTest12::copyValuesImpl(
	QtnPropertySet *propertySetCopyFrom, QtnPropertyState ignoreMask)
{
	Q_UNUSED(ignoreMask);

	auto theCopyFrom =
		qobject_cast<QtnPropertySetTest12 *>(propertySetCopyFrom);
	if (!theCopyFrom)
		return false;
